...
<head>
     ...
     <!-- Custom Style -->
     <style>
         body, h3, label, input, select, option, .form-check-label, .btn {
...
<body background="img/bg/flower.jpg">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">DATABASE STUDENTS</a>
          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              <label for="nis" class="form-label">NUMBER</label>
                         ...
                         <div class="mb-3">
                              <label for="tmpt_Lahir" class="form-label">BORN</label>
                         ...
                         <div class="mb-3">
                              ...
                              <div class="form-check">
                                   <input class="form-check-input" type="radio" name="jekel" id="Laki - Laki"
                                        value="Laki - Laki">
                                   <label class="form-check-label" for="Laki - Laki">Mr</label>
                              </div>
                              <div class="form-check">
                                   <input class="form-check-input" type="radio" name="jekel" id="Perempuan"
                                        value="Perempuan">
                                   <label class="form-check-label" for="Perempuan">Mrs</label>
                              </div>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                              <label for="gambar" class="form-label">YOUR PICTURE</label>
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         Pembuat:
                         Aisha Smita Mada (12030122120058)
                    </p>
               </div>
          </div>
     </div>
